...
def main():
    ...
    print(dogs)
    print(doggy + " was removed from the front of the list, using pop():")
    pause()
    ...
    print("\nRemove a dog by name rather than position in the list, using remove(Annabelle):")
    print(dogs)
    pause()
    ...
    print("\nUse a FOR loop to give each dog in the the same last time, using the for loop:")
