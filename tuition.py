...
def perform_calculations():
    global tuition, inst_fee, cap_fee, scholarship_amt, act_fee, total, balance
    ...
    if inout == 1:
        ...
        total = tuition + cap_fee + inst_fee + act_fee - scholarship_amt
        balance = total
...
def display_results():
    ...
    print('Scholarship Amount $ ' + format(scholarship_amt,currency))
